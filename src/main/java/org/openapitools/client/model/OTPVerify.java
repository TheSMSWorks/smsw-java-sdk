...
public class OTPVerify {
  ...
  public OTPVerify passcode(String passcode) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    OTPVerify otPVerify = (OTPVerify) o;
    return Objects.equals(this.passcode, otPVerify.passcode);
  }
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OTPVerify.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OTPVerify' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OTPVerify> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OTPVerify.class));

       return (TypeAdapter<T>) new TypeAdapter<OTPVerify>() {
           @Override
           public void write(JsonWriter out, OTPVerify value) throws IOException {
 ...
 /**
  * Create an instance of OTPVerify given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OTPVerify
  * @throws IOException if the JSON string is invalid with respect to OTPVerify
  */
  public static OTPVerify fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OTPVerify.class);
  }

 /**
  * Convert an instance of OTPVerify to an JSON string
  *
  * @return JSON string
  */
